...
public interface WorkspaceRepository {
    @Results(id = "workspaceMap", value = {
            ...
            @Result(property = "members", column = "workspace_id", many = @Many(select = "getAllMemberInEachWorkspace"))
    })
    @Select("""
    ...
    @Select("SELECT uw.user_id, username, email, is_owner, accessibility_status FROM users INNER JOIN user_workspace uw on users.user_id = uw.user_id WHERE workspace_id = #{workspaceId};")
